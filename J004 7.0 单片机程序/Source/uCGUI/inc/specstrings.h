...
# define __nothrow
    ...
    //
    // __blocksOn(resource) v
    //
    // Annotates a return value v. States that this API blocks on the resource 'resource'
    //
    // EG: __blocksOn(network)
    //     __blocksOn(disk)
    //
    #define __blocksOn(resource)        __declspec("SAL_blocksOn("SPECSTRINGIZE(resource)")")

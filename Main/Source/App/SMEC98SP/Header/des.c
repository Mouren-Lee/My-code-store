...
const unsigned char DesS[8][4][16] = 
{
	{
...
void movram(unsigned char* source,unsigned char* target,unsigned char length);
void doxor(unsigned char* sourceaddr,unsigned char* targetaddr,unsigned char length);
void setbit(unsigned char* dataddr,unsigned char pos,unsigned char b0);
unsigned char getbit(unsigned char* dataddr,unsigned char pos);
void selectbits(unsigned char* source,const unsigned char* table,unsigned char* target,unsigned char count);
void shlc(unsigned char* data_p);
void shrc(unsigned char* data_p);
void strans(unsigned char* index,unsigned char* target);

...
#define GUI_TA_RIGHT1	     (3<<0)
#define GUI_TA_LEFT1        (4<<0)

/* Text alignment flags, vertical */
#define GUI_TA_VERTICAL   (7<<3)
#define GUI_TA_TOP	      (0<<3)
#define GUI_TA_BOTTOM	    (1<<3)
#define GUI_TA_BASELINE   (2<<3)
#define GUI_TA_VCENTER    (3<<3)
#define GUI_TA_BOTTOM1	    (4<<3)
...
extern GUI_CONST_STORAGE GUI_BITMAP bm96hailida;
